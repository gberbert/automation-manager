...
import { Save, Plus, Trash2, Linkedin as LinkedinIcon, MessageSquare, Key, Eye, EyeOff, BookOpen, CheckCircle, AlertTriangle } from 'lucide-react';
        ...
        <div className="space-y-8 pb-20">
            ...
            <div className="flex space-x-4 border-b border-gray-700 overflow-x-auto">
                <button
                    ...
                    className={`pb-4 px-4 font-medium transition-colors relative whitespace-nowrap ${activeTab === 'connection' ? 'text-blue-400' : 'text-gray-400 hover:text-white'}`}
                >
                ...
                <button
                    ...
                    className={`pb-4 px-4 font-medium transition-colors relative whitespace-nowrap ${activeTab === 'prompt' ? 'text-blue-400' : 'text-gray-400 hover:text-white'}`}
                >
                ...
                <button
                    ...
                    className={`pb-4 px-4 font-medium transition-colors relative whitespace-nowrap ${activeTab === 'guide' ? 'text-yellow-400' : 'text-gray-400 hover:text-white'}`}
                >
            ...
            {activeTab === 'connection' && (
                <div className="bg-gray-800/50 backdrop-blur p-6 rounded-xl border border-gray-700 space-y-6 animate-fadeIn">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-500">Must match exactly what is in LinkedIn Developer Portal (no trailing slashes).</p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-700">
                        ...
                        <p className="text-xs text-gray-500 mt-2 text-center">
                            {settings.linkedinAccessToken ? '✅ Token Saved & Active' : 'Click to get Access Token'}
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-gray-500 text-yellow-500">
                            ⚠️ Recomendado: Deixe vazio para o sistema detectar automaticamente. Só preencha se tiver problemas.
                        </p>
                    </div>
                </div>
            )}
                ...
                <div className="space-y-6 animate-fadeIn">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-800/50 backdrop-blur p-6 rounded-xl border border-gray-700 space-y-4">
                            ...
                            <textarea
                                ...
                                placeholder="Ex: Foque em vendas B2B..."
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800/50 backdrop-blur p-6 rounded-xl border border-gray-700 space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            />
                            <button onClick={addTopic} className="bg-green-600 hover:bg-green-500 text-white px-6 py-2 rounded-lg flex items-center justify-center">
